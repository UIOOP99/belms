...
from lms_proto import course_pb2 as lms__proto_dot_course__pb2
...
class CourseControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_stream(
                '/lms_proto.CourseController/List',
                request_serializer=lms__proto_dot_course__pb2.CourseListRequest.SerializeToString,
...
def add_CourseControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=lms__proto_dot_course__pb2.CourseListRequest.FromString,
...
class CourseController(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/lms_proto.CourseController/List',
            lms__proto_dot_course__pb2.CourseListRequest.SerializeToString,
